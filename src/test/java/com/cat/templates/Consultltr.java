...
public class Consultltr extends GenericTemplateMethods {
	...
	@Test(groups = { "Regression", "Sanity", "NextOnly" }, testName="FLDXTWO-4705", dependsOnMethods = { "selectConsultSaqCorrectSubmit" }, priority=31)
	...
	/*@Test(testName="FLDXTWO-4618")
	public void testConsultltr() throws Exception {
		TakeScreenshot("Pass");
		checkNEXTDisable();
