...
public class Basicttb extends GenericTemplateMethods{
	...
	public void MainImage() throws Exception {
		if (!verifyElementPresent("MainImage-ttb")) {
		...
		verifyElementImagePresent("MainImage-ttb");
