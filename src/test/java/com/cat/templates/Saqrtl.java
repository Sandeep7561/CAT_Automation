...
public class Saqrtl extends GenericTemplateMethods {
	...
	public void MainImage() throws Exception {
		if (!verifyElementPresent("MainImage-rtl")) {
			logSKIP("Skipping test because MainImage was not available");
			throw new SkipException("Skipping test because MainImage-rtl was not available.");
		}	
		verifyElementImagePresent("MainImage-rtl");
		logPASS("MainImage is Present");
	}	

	@Test(groups = { "Regression" }, testName="FLDXTWO-4712", priority=5)
	...
	@Test(groups = { "Regression", "Sanity" }, testName="FLDXTWO-4713", dependsOnMethods = { "selectSaqCorrectOptions" }, priority=7)
	...
	@Test(groups = { "Regression" }, testName="FLDXTWO-4713", dependsOnMethods = { "selectSaqCorrectSubmit" }, priority=9)
	...
	@Test(groups = { "Regression" }, testName="FLDXTWO-4714", dependsOnMethods = { "selectSaqCorrectOptions" }, priority=13)
	public void selectSaqIncorrectoptions() throws Exception {
		clickSaqIncorrectOptions();
		logPASS("PASS");
	}

	@Test(groups = { "Regression" }, testName="FLDXTWO-4714", dependsOnMethods = { "selectSaqIncorrectoptions" }, priority=14)
	public void selectSaqIncorrectSubmit() throws Exception {
		clickSaqIncorrectSubmit();
		logPASS("PASS");
	}

	@Test(groups = { "Regression" }, testName="FLDXTWO-4714", dependsOnMethods = { "selectSaqIncorrectSubmit" }, priority=15)
	...
	/*@Test
	public void testSaqrtl() throws Exception {
		checkNEXTDisable();
