...
public class Concernrtl extends GenericTemplateMethods {
	...
	@Test(groups = { "Regression", "Sanity" }, testName="FLDXTWO-4711", priority=12)
	...
	@Test(groups = { "Regression", "Sanity", "NextOnly" }, testName="FLDXTWO-4715", priority=26)
	...
	@Test(groups = { "Regression", "Sanity", "NextOnly" }, testName="FLDXTWO-4705", priority=30)
	...
	/*@Test
	public void testConcernrtl() throws Exception {
		TakeScreenshot("Pass");
		checkNEXTDisable();
